...
Window {
    id: root
    // property var 定义了一组按钮类型的属性，如 mb_OK、mb_SAVE 等
    ...
    modality: Qt.ApplicationModal  // modality设置为 Qt.ApplicationModal，表示消息框在应用程序内是模态的，即消息框出现时，其他窗口无法操作。
    flags: Qt.FramelessWindowHint | Qt.Window  // 设置了窗口样式为无边框。
...
//                color: "white"
            ...
            Button {  //  显示关闭按钮，点击时调用 checkd 函数，传递 mb_CANCEL。
                id: img
                text: "x"
                anchors.right: parent.right
