 ...
 * @brief   :
 * -----
 * Last Modified: 2024-12-20 13:44:02
 * -----
 * @history :
 * ================================================================================
...
RedisManager::RedisManager() {
    _conns_pool.reset(new RedisConnectionPool(
        status_config->redis_conn_pool_size, status_config->redis_host.c_str(),
        status_config->redis_port, status_config->redis_pass.c_str()));
}
