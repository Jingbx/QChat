 ...
 * @brief   :
 * -----
 * Last Modified: 2024-12-20 13:43:47
 * -----
 * @history :
 * ================================================================================
...
extern GeneralConf *status_config;

MysqlDao::MysqlDao() {

    _conns_pool.reset(new MysqlConnectionPool(
        status_config->mysql_conn_pool_size, status_config->mysql_host,
        status_config->mysql_port, status_config->mysql_user,
        status_config->mysql_pass, status_config->mysql_schema));
}
