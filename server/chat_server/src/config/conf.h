/**
 * @file    : /Users/jingbx/Qt.6.0.0/workspace/Qchat/server/chat_server/src/config/conf.h
 * @date    : 2024-12-20 09:49:15
 * @author  : Jingbx(18804328557@163.com)
 * @brief   :
 * -----
 * Last Modified: 2024-12-31 20:28:14
 * -----
 * @history :
 * ================================================================================
...
struct GeneralConf {
    ...
    std::string         chat_self_server_name;
    std::string         chat_self_server_host;
    uint16_t            chat_self_server_port;
    uint16_t            chat_self_server_rpcport;
